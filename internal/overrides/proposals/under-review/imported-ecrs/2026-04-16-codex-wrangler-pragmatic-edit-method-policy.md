...
During `an external project` maintenance on 2026-04-15, the active Codex session
...
Adopted locally on 2026-04-16 through
`standards-and-practices/docs/specifications/codex_wrapper_local_policy_contract.txt`.
Patch-style edits remain preferred for localized changes, while explicit
non-destructive named-file writes or short scripts are allowed for whole-file
records, generated content, mechanical transformations, or patch-helper failure.
