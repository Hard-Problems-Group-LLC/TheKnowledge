#!/usr/bin/env python3
"""Provision pyenv bootstrap/runtime contexts for a TheKnowledge checkout."""
...
INSTALLER = REPO_ROOT / "scripts" / "install_prerequisites.py"
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "contexts, then hand off to the repository installer."
        )
    )
    parser.add_argument(
        "--dry-run",
...
def main(argv: Sequence[str] | None = None) -> int:
    """Execute the pyenv bootstrap flow for TheKnowledge itself."""
    ...
    print("[bootstrap-stage2] PASS: pyenv bootstrap and installer handoff complete.")
    return 0
