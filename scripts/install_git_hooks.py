...
HOOK_SPECS = (
    HookSpec(name="pre-commit", marker_label="project entropy pre-commit"),
    HookSpec(name="pre-push", marker_label="project quality gate pre-push"),
)


def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Install managed pre-commit and pre-push hook wrappers for project."
    )
    parser.add_argument(
        "--repo-root",
